...
public class ButtonTouchCorrection : MonoBehaviour
{
    ...
    void TouchCorrection()
    {
        ...
        for (int i = 0; i < Input.touchCount; i++)
        {
            ...
            if (hit.collider)
            {
                if (hit.collider.transform.parent.name.Equals("Button"))
                {
                ...
                else if (hit.collider.transform.parent.name.Equals("DirectionKey"))
                {
