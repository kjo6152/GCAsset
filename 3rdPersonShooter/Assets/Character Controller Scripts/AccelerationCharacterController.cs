...
public class AccelerationCharacterController : MonoBehaviour {
    public Vector2 joystickInput = new Vector2();
	...
	void Update () {
		...
		directionVector.z += joystickInput.x * Time.deltaTime*accelerationSpeed;
		directionVector.x += joystickInput.y * Time.deltaTime*accelerationSpeed;
